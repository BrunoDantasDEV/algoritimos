// 1 - Fulano precisa de um software que ao passar uma entrada, ele imprime os valores de 0 até valor X que ele passar, ele quer automatizar isso para otimizar seu 
//tempo e ser mais produtivo.
...
const readline = require("readline");
  ...
  const rl = readline.createInterface({ // importando entrada
    input: process.stdin,   //informandoentrada
    output: process.stdout  //informando a saida
  });
